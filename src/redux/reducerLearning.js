const defaultState = {
  ...
  \
  1) Mass Effect \n \
  Em Mass Effect o personagem Jeff “Joker” Moreau tem um caso moderado a grave da síndrome de Vrolik \
  (Osteogenesis imperfecta), que causa extrema fragilidade nos ossos; ele nasceu com fraturas graves nas pernas e,\
   mesmo com a medicina moderna, acha quase impossível andar, contando com muletas e aparelhos para as pernas. \n \
   \n \
  2) Grand Theft Auto V  \n \
  Em GTA 5 o personagem Lester Crest sofre de uma doença devastadora que gradualmente desgastou suas habilidades \
  motoras durante sua vida e o deixou em cadeira de rodas. Devido à sua mobilidade limitada, Lester cresceu \
  consideravelmente acima do peso e também sofre de asma."
}
