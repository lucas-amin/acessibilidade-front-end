...
const questions = {
    ...
    "regras": [{
        ...
        correct_answer: 1 ,
        videos: [{"url":"https://www.youtube.com/watch?v=wfBiGDcdA9M", "alt": "QTE's de Spider Man"}],
        justify_awnser: "Regra, pois é uma condição de vitória que pode ser mudada em virtude da necessidade do jogador."
    },{
        title: "Questão 2",
        ...
        justify_awnser: "Deixar o usuário controlar as regras de forma que o jogo se torne uma experiencia agradavel independente das suas dificuldades é um exemplo de regra acessivel."
    },{
        title: "Questão 3",
        ...
        justify_awnser: "Para filmes a legenda é um tecnologia muito bem padronizada com regras definidas, porém para jogos não há nenhum padrão o que gera situações com letras muito pequenas, ou em tons que não tornam a legenda impossivel de ser lida."
    }],
    "objetivos": [{
        title: "Questão 1",
        question: "O jogo Horizon Zero Dawn disponibiliza um menu de seleção dificuldade com multiplos niveis, sendo eles: Story, Easy, Normal, Hard and Very Hard; e em todos os esse niveis de dificuldade é possivel conseguir todos os archivments do jogo. Mesmo archivments sendo considerados objetivos não necessários para compreenção do jogo, a opção de disponibilizar esse menu é uma forma de tornar os objetivos acessiveis?",
        alternatives: ["Sim", "Não"],
        correct_answer: 0 ,
        justify_awnser: "Possibilitar o usuário decidir o quão dificil os objetivos (mesmo objetivos secundários) serão dentro do jogo tornam os objetivos acessiveis."
    },{
        title: "Questão 2",
        ...
        alternatives: ["Sim, pois os jogadores deveriam ter a possibilidade de conseguir todos os objetivos do jogo independente das carateristicas dos jogadores","Não, pois achievements são objetivos secundários", "Não, pois archivments não são objetivos do jogo" ],
        correct_answer: 0 ,
        images:[{"url":"http://gameaccessibilityguidelines.com/wp-content/uploads/2018/01/celeste3.jpg", "alt": "Menu de acessibilidade do jogo Celeste"}],
        justify_awnser: "Possibilitar o usuário decidir o quão dificil os objetivos (mesmo objetivos secundários) serão dentro do jogo tornam os objetivos acessiveis e portanto o achievement citado não é um objetivo acessivel."
    }],
    "mecanicas": [{
        title: "Questão 1",
        ...
        alternatives: ["Sim", "Não"],
        correct_answer: 1 ,
        videos: [{"url": "https://youtu.be/dYdlY935gCo?t=43", "alt": "Exemplo de gameplay do jogo Hearthstone"}],
        justify_awnser: "Possibilitar o usuário decidir o quão dificil os objetivos (mesmo objetivos secundários) serão dentro do jogo tornam os objetivos acessiveis."
    }]
}
